...
import (
	...
	"github.com/ihcsim/cbt-aggapi/pkg/generated/discovery/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type DiscoveryV1alpha1Interface interface {
	RESTClient() rest.Interface
	CSIDriverEndpointsGetter
}

// DiscoveryV1alpha1Client is used to interact with features provided by the discovery.storage.k8s.io group.
type DiscoveryV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DiscoveryV1alpha1Client) CSIDriverEndpoints(namespace string) CSIDriverEndpointInterface {
	return newCSIDriverEndpoints(c, namespace)
}
