...
func (m *memory) Connect(ctx context.Context, id string, options runtime.Object, r registryrest.Responder) (http.Handler, error) {
...
// See https://pkg.go.dev/k8s.io/apiserver/pkg/registry/rest#Connecter
func (m *memory) NewConnectOptions() (runtime.Object, bool, string) {
	return &v1alpha1.VolumeSnapshotDeltaOption{}, false, ""
}

// ConnectMethods returns the list of HTTP methods handled by Connect
// See https://pkg.go.dev/k8s.io/apiserver/pkg/registry/rest#Connecter
func (m *memory) ConnectMethods() []string {
	return []string{"GET"}
}
...
func (m *memory) Create(ctx context.Context, obj runtime.Object, createValidation registryrest.ValidateObjectFunc, options *metav1.CreateOptions) (runtime.Object, error) {
